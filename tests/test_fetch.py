...
class TestFetch:
    ...
    def test_item_date_succeeds(self, runner):
        ...
        result = runner.invoke(fetch.cli, ["-t", "2020-06-06", "item", "2"])
    ...
    def test_item_interval_default_succeeds(self, runner):
        ...
        result = runner.invoke(fetch.cli, ["item", "2"])
    ...
    def test_item_interval_succeeds(self, runner):
        ...
        result = runner.invoke(
            fetch.cli,
            ["-t0", "2020-06-06T00:00:00", "-t1", "2020-08-06T00:00:00", "item", "2"],
        )
    ...
    def test_item_interval_upper_succeeds(self, runner):
        ...
        result = runner.invoke(fetch.cli, ["-t1", "2020-08-06T00:00:00", "item", "2"])
    ...
    def test_item_interval_lower_succeeds(self, runner):
        ...
        result = runner.invoke(fetch.cli, ["-t0", "2020-06-06T00:00:00", "item", "2"])
    ...
    def test_category_date_succeeds(self, runner):
        ...
        result = runner.invoke(fetch.cli, ["-t", "2020-06-06", "category", "38"])
    ...
    def test_category_fails(self, runner):
        ...
        result = runner.invoke(fetch.cli, ["category", "9999"])
